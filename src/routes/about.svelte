<script>
    ...
    import vid from "../assets/vids/Taxinet Services.mp4"
...
<svelte:head>
	<title>Taxinet | About</title>
</svelte:head>
<Header />

<section class="services-container" in:fly={{ y: 50, duration: 500, delay: 500 }} out:fly={{ duration: 500 }}>
