<script>
	...
	let fiat_brands = ['MOBI', 'NEW 500', 'PANDA', 'UNO', 'ARGO', 'CRONOS', 'TIPO', 'PULSE'];
	...
	let inifinity_brands = ['Q50', 'Q60', 'QX50', 'QX55', 'QX60', 'QX80'];
	let jeep_brands = [
		'CHEROKEE',
		'COMPASS',
		'COMMANDER',
	...
	let lexus_brands = ['CT', 'IS', 'ES', 'LS', 'RC', 'LC', 'UX', 'NX', 'RX', 'RZ'];
	let mazda_brands = [
		'MAZDA2',
		'MAZDA2 HYBRID',
		'MAZDA3',
	...
	let opel_brands = ['ASTRA', 'CORSA', 'INSIGNIA', 'CROSSLAND', 'GRANDLAND', 'MOKKA'];
	let peugot_brands = ['208', '308', '301', '408', '508'];
	let renault_brands = [
		'CLIO',
		'KWID',
		'MÉGANE',
		...
		<form on:submit|preventDefault={handleRegisterVehicle}>
			<div class="form-box">
				<table>
					<div class="box1">
						<tr>
							<td><label for="status" class="form__label">Status</label></td>
							<td
						...
						<tr>
							<td><label for="description" class="form__label">License plate number</label></td>
							<td
								><input
									type="text"
									id="lpn"
						...
						<tr>
							<td><label for="make" class="form__label">Make</label></td>
							<td
						...
						<tr>
							<td><label for="description" class="form__label">Vin</label></td>
							<td
								><input
									type="text"
									id="lpn"
						...
						<tr>
							<td><label for="poster" class="form__label">Model</label></td>
							<td
						...
						<tr>
							<td><label for="status" class="form__label">Color</label></td>
							<td
						...
						<tr>
							<td
								><label for="description" class="form__label"
									>Vehicle registration certificate</label
								></td
							>
							<td
								><input
						...
						<tr>
							<td><label for="status" class="form__label">Fleet car</label></td>
							<td
						...
						<tr>
							<td><label for="status" class="form__label">Category</label></td>
							<td
					...
					<div class="box2">
						<tr>
							<td><label for="description" class="form__label">Year</label></td>
							<td
								><input
									type="text"
									id="lpn"
						...
						<tr>
							<td><label for="description" class="form__label">License</label></td>
							<td
								><input
									type="text"
									id="lpn"
						...
						<tr>
							<td><label for="status" class="form__label">Boosters</label></td>
							<td
						...
						<tr>
							<td><label for="status" class="form__label">Transmission</label></td>
							<td
						...
						<tr>
							<td><label for="description" class="form__label">LightBox</label></td>
							<td
								><input
									type="checkbox"
									id="lpn"
						...
						<tr>
							<td><label for="description" class="form__label">Branded Wrap</label></td>
							<td
								><input
									type="checkbox"
									id="lpn"
						...
						<tr>
							<td><label for="status" class="form__label">Child safety seats</label></td>
							<td
								><select
									name="status"
									bind:value={child_safety_seats}
									class="form__input"
									id="status"
								>
									<option value="0">0</option>
						...
						<tr>
							<td><label for="description" class="form__label">Code Name</label></td>
							<td
								><input
									type="text"
									id="lpn"
			...
			{:else}
				<table>
					<tr>
						<td><button class="form__button">Save</button></td>
					</tr>
				</table>
			{/if}
			<br />
